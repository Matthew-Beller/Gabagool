...
def prompt_user():
    ...
    single_file_video.add_argument('source_file_video_parsing', metavar="Video File", widget="FileChooser")
...
if(args.action == 'Single_Subtitle_File'):
    ...
    source_file_video_parsing = args.source_file_video_parsing
...
if(args.action == 'Single_Subtitle_File'):
    ...
    video_editing_functions.clipTogetherVideos(source_file_video_parsing, source_file_subtitle_found, output_directory)
else:
    pass
