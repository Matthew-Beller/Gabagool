...
def prompt_user():
    ...
    single_file_subtitle.add_argument('--ignore_spaces', metavar="Ignore Spaces during Search", help=" Ignore", widget="CheckBox", default=True)
    single_file_subtitle.add_argument('--ignore_punctuation', metavar="Ignore Punctuation during Search", help=" Ignore", widget="CheckBox", default=True)
    single_file_subtitle.add_argument('--ignore_case', metavar="Case Sensitive Search", help=" Recognize Case", widget="CheckBox", default=False)
    ...
    batch_files_subtitle.add_argument('--ignore_spaces', metavar="Ignore Spaces during Search", help=" Ignore", widget="CheckBox")
    batch_files_subtitle.add_argument('--ignore_punctuation', metavar="Ignore Punctuation during Search", help=" Ignore", widget="CheckBox", default=True)
    batch_files_subtitle.add_argument('--ignore_case', metavar="Case Sensitive Search", help=" Recognize Case", widget="CheckBox", default=False)
