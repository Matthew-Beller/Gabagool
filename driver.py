...
def prompt_user():
    ...
    single_file_video.add_argument('--speed_increase', metavar="Speed Increase of Each Clip", nargs="?", const="", default=0, type=int, required=False)
    ...
    separate_file_video.add_argument('--speed_increase', metavar="Speed Increase of Each Clip", nargs="?", const="", default=0, type=int, required=False)
...
def main():
    ...
    if(args.action == 'Single_Subtitle_File'):
        ...
        speed_increase = args.speed_increase
    ...
    if(args.action == 'Single_Subtitle_File'):
        ...
        video_editing_functions.mergeMultipleClips(source_file_subtitle_found, output_directory, buffer_time_start, buffer_time_end, speed_increase)

    elif(args.action == 'Separate_Video_Files'):
        video_editing_functions.saveAsIndividualClips(source_file_subtitle_found, output_directory, buffer_time_start, buffer_time_end, speed_increase)
    elif(args.action == 'Extact_Subtitle_File_From_Video'):
